<h1 align="center">Node.js Tubyte Bot API</h1>
...
>```sh
>npm install --save-dev @types/node-tubyte-bot-api
>```

## 🚀 Usage

```js
const TelegramBot = require('node-tubyte-bot-api');
