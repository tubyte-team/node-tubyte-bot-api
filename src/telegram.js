...
class TelegramBot extends EventEmitter {
   ...
   * @param {String} [options.baseApiUrl="https://api.tubyte.me"] API Base URl; useful for proxying and testing
  ...
  constructor(token, options = {}) {
    ...
    this.options.baseApiUrl = options.baseApiUrl || 'https://api.tubyte.me';
   ...
   */
  _buildURL(_path) {
    return `${this.options.baseApiUrl}/user${this.token}${this.options.testEnvironment ? '/test' : ''}/${_path}`;
  }
